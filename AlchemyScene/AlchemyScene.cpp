...
void AlchemyScene::initChar(int winWidth, int winHeight){
	...
	/*
	 auto sprite = Sprite::create("HomunImg/NH3/NH3_Card_SD_normal.png");
	 sprite->setPosition(winWidth / 2, winHeight / 2);
	 this->addChild(sprite);
	 
	 Texture2D *testTex = TextureCache::sharedTextureCache()->addImage("HomunImg/NH3/NH3_Card_SD_angry.png");
	 sprite->setTexture(testTex);
	 Texture2D *smile = TextureCache::sharedTextureCache()->addImage("HomunImg/NH3/NH3_Card_SD_smile.png");
	 sprite->setTexture(smile);
	 */
	
	auto CharLeft = Sprite::create("HomunImg/Default.png");
	CharLeft->setTag(10);
	CharLeft->setPosition(Point(CharLeft->getContentSize().width / 2, CharLeft->getContentSize().height / 2));
	auto CharRight = Sprite::create("HomunImg/Default.png");
	CharRight->setTag(20);
	CharRight->setPosition(Point(winWidth - CharRight->getContentSize().width / 2, CharRight->getContentSize().height / 2));
	
	Texture2D* H2_normal = TextureCache::sharedTextureCache()->addImage("HomunImg/H2/H2_Card_SD_normal.png");
	
	Texture2D* O2_normal = TextureCache::sharedTextureCache()->addImage("HomunImg/O2/O2_Card_SD_normal.png");
...
void AlchemyScene::Event(Ref *pSrnder){
	auto CharLeft = (Sprite*)this->getChildByTag(10);
	auto CharRight = (Sprite*)this->getChildByTag(20);
	...
	switch (talkNo) {
		case 0:{
			CharLeft->setColor(Color3B(128,128,128));
